...
<template>
  <a-modal v-model:open="visible" :title="formState.departmentId ? '编辑部门' : '添加部门'" @ok="handleOk" destroy-on-close>
    <a-form ref="formRef" :model="formState" :rules="rules" layout="vertical">
      <a-form-item label="上级部门" name="parentId" v-if="formState.parentId !== 0">
        <DepartmentTreeSelect
          ref="departmentTreeSelect" v-model:value="formState.parentId" :default-value-flag="false"
          width="100%"
        />
      </a-form-item>
      ...
      <a-form-item label="部门负责人" name="managerId">
        <EmployeeSelect
          ref="employeeSelect" placeholder="请选择部门负责人" width="100%" v-model:value="formState.managerId"
          :leave-flag="false"
        />
      </a-form-item>
