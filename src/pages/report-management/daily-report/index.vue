...
async function fetchList() {
  loading.value = true
  try {
    const begin = date.value ? dayjs(date.value).format("YYYY-MM-DD") : ""
    const end = begin
    ...
    <template #searchSlot>
      <div class="search-bar" v-loading="loading">
        <div class="left">
          ...
          <el-date-picker v-model="date" type="date" format="YYYY-MM-DD" value-format="YYYY-MM-DD" placeholder="选择日期" />
