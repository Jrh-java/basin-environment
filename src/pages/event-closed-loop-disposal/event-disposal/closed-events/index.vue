...
defineOptions({ name: "ClosedEvents" })
...
function handleEvaluate(row: any) {
  ElMessage.success(`评价事件：${row.eventName}`)
}
</script>

<template>
  <div class="closed-events-container">
    <SearchTableLayout>
      <template #searchSlot>
          ...
          <el-table v-loading="loading" :data="tableData" style="width: 100%" border>
            ...
            <el-table-column label="操作" width="150" align="center" fixed="right">
              <template #default="{ row }">
                ...
                <el-button link type="success" @click="handleEvaluate(row)">
                  评价
                </el-button>
              </template>
            </el-table-column>
