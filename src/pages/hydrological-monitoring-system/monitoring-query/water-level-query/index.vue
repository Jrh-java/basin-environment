...
function updateChart() {
  ...
  const values = [6.5, 8.8, 11.2, 8.8, 10.1, 8.8, 9.5, 8.8]
    ...
    <template #tableSlot>
      <el-card shadow="never" class="table-card">
        <el-table v-loading="loading" :data="tableData" style="width: 100%" border>
          ...
          <el-table-column prop="temperature" label="温度" min-width="80" align="center" />
          <el-table-column prop="monitorLevel" label="监测水位(m)" min-width="120" align="center" />
          <el-table-column prop="ecoLevel" label="生态水位(m)" min-width="120" align="center" />
          <el-table-column prop="maxLevel" label="最高水位(m)" min-width="120" align="center" />
