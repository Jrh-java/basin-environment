...
import { Refresh, Right, Search, View } from "@element-plus/icons-vue"
    ...
    <template #tableSlot>
      <el-card shadow="never" class="table-card">
        <el-table v-loading="loading" :data="tableData" style="width: 100%" border>
          ...
          <el-table-column label="流量趋势" min-width="150" align="center">
            <template #default="{ row }">
              <TrendLine :data="row.trendData" color="#409eff" />
            </template>
          </el-table-column>
